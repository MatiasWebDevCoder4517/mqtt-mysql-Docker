...
class Settings(BaseSettings):
    ...
    PROJECT_NAME: str = 'desafio-backend'
    ALGORITHM = 'HS256'
    ACCESS_TOKEN_EXPIRE_MINUTES: int = 60
    SECRET_KEY: str = '09d25e094faa6ca2556c818166b7a9563b93f7099f6f0f4caa6cf63b88e8d3e7'

    MYSQL_SERVER: str = os.getenv('MYSQL_SERVER', 'localhost:3306')
    MYSQL_USER: str = os.getenv('MYSQL_USER', 'root')
    MYSQL_PASSWORD: str = os.getenv('MYSQL_PASSWORD', 'Matias')
    MYSQL_DB: str = os.getenv('MYSQL_DB', 'tecnoandina')
    ...
    TEST_USER_PASSWORD: str = 'test_user'
    
    ## NEEDS SUPER ADMIN IMPLEMENTATION ##
